...
public class Index {	
	...
	//New Code
	public static void visuals(Piece[][] board) {
        //ChessVisuals chessVisuals = new ChessVisuals();
        run(board);
    }

    public static void run(Piece[][] board) {
    ...
    public static void createBoard(Shell shell, Display display) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            for (int j = 0; j < 8; j++) {
                ...
                label.setFont(new Font(display, "Helvetica", 16, SWT.BOLD));
                ...
                if (i == 0) {
                    label.setText(String.valueOf(colChar));
                    colChar++;
                }
    ...
    public static void createInputSection(Shell shell) {
        ...
        enterButton.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false));
        //board on start
        updateBoardVisuals(); 
